...
import getContacts from "@salesforce/apex/ContactHelper.getContactsList";
...
export default class InlineEditDataTableLWC extends LightningElement {
    @api recordId  =  '0012v00002pJCnuAAG';
  columns = COLS;
  draftValues = [];
